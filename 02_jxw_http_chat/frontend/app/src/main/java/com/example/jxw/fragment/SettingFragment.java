...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        etServerIp.setText(sharedPreferences.getString("server_ip", "172.20.10.2"));
        etServerPort.setText(sharedPreferences.getString("server_port", "8000"));
    ...
    private void saveSettingsToSharedPreferences() {
        ...
        editor.putString("server_port", etServerPort.getText().toString().trim());
        editor.apply();  // 保存變更
    }
